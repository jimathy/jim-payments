Loc["en"] = {
    dialog = {
        ['clerk_check'] = "The clerk is checking the money.",
        ['clerk_caught'] = "The clerk has called the police.",
    },
    error = {
        ["cancel"] = "Cancelled",
        ...
        ["dirty_low"] = "Not enough dirty cash",
    ...
    menu = {
        ...
        ["header_option_dirty"] = "<br><br>- Money Options -<br>",
        ["dirty_balance"] = "<br>💰Dirty - $",
